...
private:
	...
	DEFINE_PARAMETERS(
		...
		(ParamFloat<px4::params::AV_ATS_MP_LO_V>)   _params_av_ats_mp_lo_v,
		(ParamFloat<px4::params::AV_ATS_PARA_LO_V>) _params_av_ats_para_lo_v,
		(ParamFloat<px4::params::AV_ATS_PARA_HI_V>) _params_av_ats_para_hi_v,
		(ParamFloat<px4::params::AV_ATS_UPS_LO_V>)  _params_av_ats_ups_lo_v,
		(ParamFloat<px4::params::AV_ATS_UPS_HI_V>) _params_av_ats_ups_hi_v,
